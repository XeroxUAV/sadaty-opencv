...
class WindowDetector:
    def __init__(self):
        ...
        cv2.createTrackbar("LV1", "HSV", 177, 255, lambda x: None)
        ...
        # HSV2
        cv2.createTrackbar("LH2", "HSV", 116, 179, lambda x: None)
        cv2.createTrackbar("LS2", "HSV", 84, 255, lambda x: None)
        cv2.createTrackbar("LV2", "HSV", 75, 255, lambda x: None)
        cv2.createTrackbar("UH2", "HSV", 128, 179, lambda x: None)
        cv2.createTrackbar("US2", "HSV", 146, 255, lambda x: None)
        ...
        cv2.createTrackbar("MinArea", "HSV", 10000, 50000, lambda x: None)
...
class DroneController:
    def __init__(self):
        ...
        self.tello.send_rc_control(0, 0, 20, 0)  # 30 = moderate throttle up
        ...
        self.pid_yaw = PID(Kp=0.05, Ki=0.001, Kd=0.02)
